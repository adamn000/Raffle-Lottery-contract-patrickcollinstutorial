...
/**
 * @notice This scripts are programmatic version of creating chainlink subscription, fund it and add customer. It *  might be done trough the chainlink website as well.
 */
